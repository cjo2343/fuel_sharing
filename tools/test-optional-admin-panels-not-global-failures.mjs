...
assert(app.includes('startAdminDiagnosticsLane("admin-tab-open")'), 'opening Admin should start the separated backend-context diagnostics lane');
assert(app.includes('markOptionalAdminPanelsReadyForManualRefresh(reason)'), 'Admin diagnostics lane should still mark optional panels as manual first');
