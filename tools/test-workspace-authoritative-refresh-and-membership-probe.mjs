...
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v(?:394|395|396|397|398|399|400|401|402|403|404|405|406|407|408|409|410|411|412|413|414|415|416|417|418|419|420|421|422)"/, 'build-info should point to v381 cache.');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v(?:394|395|396|397|398|399|400|401|402|403|404|405|406|407|408|409|410|411|412|413|414|415|416|417|418|419|420|421|422)"/, 'service worker cache should be bumped to v371.');
...
assert.match(app, /renderWorkspaceToolsUrl\s*=\s*renderApiEndpoints\.workspaceTools\s*\|\|\s*"\/api\/workspace\/tools"/, 'Workspace tools should have a Render route.');
