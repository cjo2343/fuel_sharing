...
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v369"/, 'build-info should point to v369 cache.');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v369"/, 'service worker cache should be bumped to v369.');
