...
assert.match(serviceWorker, /CACHE_NAME\s*=\s*"(?:fuel-ledger-v(?:409|410|411|412|413|414|415|416|417|418|419)|fuel-ledger-v408|fuel-ledger-v407|fuel-ledger-v406|fuel-ledger-v405|fuel-ledger-v404|fuel-ledger-v403|fuel-ledger-v402)"/, 'service worker cache should be v402');
