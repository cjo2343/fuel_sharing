...
assert.match(buildInfo, /buildLabel:\s*"(?:bounded-supabase-reads|stuck-latch-watchdog|interactive-action-timeout-lane|workspace-action-authority-lane|owner-passive-background-sync-calm-lane|render-api-client-extraction-lane|update-prompt-bridge-workspace-retention-lane|update-prompt-workspace-visibility-lane|general-action-route-timing-lane|action-session-cache-shell-lane|interactive-action-recovery-lane|write-context-fast-fail-lane|no-refresh-action-chain-lane|post-action-unblock-lane|no-refresh-action-chain-lane)"/, 'build-info should use post-action unblock label');
...
assert.match(serviceWorker, /CACHE_NAME\s*=\s*"(?:fuel-ledger-v(?:409|410|411|412|413|414|415|416|417|418|419|420|421)|fuel-ledger-v408|fuel-ledger-v407|fuel-ledger-v406|fuel-ledger-v405|fuel-ledger-v404|fuel-ledger-v403|fuel-ledger-v402)"/, 'service worker cache should be v402');
