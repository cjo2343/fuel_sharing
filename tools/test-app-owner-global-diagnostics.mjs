...
assert.match(buildInfo, /expectedServiceWorkerCache:\s*"fuel-ledger-v375"/, 'build-info should point to v375 cache.');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v375"/, 'service worker cache should be bumped to v371.');
