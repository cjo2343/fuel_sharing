...
assert.match(buildInfo, /expectedServiceWorkerCache:\s*"fuel-ledger-v(?:394|395|396|397|398)"/, 'build-info should point to v381 cache.');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v(?:394|395|396|397|398)"/, 'service worker cache should be bumped to v379.');
