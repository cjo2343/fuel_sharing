...
assert.match(buildInfo, /expectedServiceWorkerCache:\s*"fuel-ledger-v393"/, 'build-info should point to v381 cache.');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v393"/, 'service worker cache should be bumped to v379.');
