...
assert.match(buildInfo, /expectedServiceWorkerCache:\s*"fuel-ledger-v380"/, 'build-info should point to v379 cache.');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v380"/, 'service worker cache should be bumped to v379.');
