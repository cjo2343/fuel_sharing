...
assert.match(buildInfo, /expectedServiceWorkerCache:\s*"fuel-ledger-v387"/, 'build-info should point to v381 cache.');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v387"/, 'service worker cache should be bumped to v379.');
