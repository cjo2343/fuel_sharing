...
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v381"/, 'build-info should expect v381 cache');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v381"/, 'service worker should publish v381 cache');
assert.match(checklist, /fuel-ledger-v381/, 'deployment checklist should document v381 cache');
