...
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v377"/, 'build-info should expect v377 cache');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v377"/, 'service worker should publish v377 cache');
assert.match(checklist, /fuel-ledger-v377/, 'deployment checklist should document v377 cache');
