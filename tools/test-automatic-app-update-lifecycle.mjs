...
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v394"/, 'build-info should expect v381 cache');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v394"/, 'service worker should publish v381 cache');
