...
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v383"/, 'build-info should expect v381 cache');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v383"/, 'service worker should publish v381 cache');
