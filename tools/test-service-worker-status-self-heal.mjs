...
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v392"/, 'build-info should expect v382 cache');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v392"/, 'service worker should publish v382 cache');
