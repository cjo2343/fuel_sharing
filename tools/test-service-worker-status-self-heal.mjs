...
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v388"/, 'build-info should expect v382 cache');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v388"/, 'service worker should publish v382 cache');
