...
assert.match(buildInfo, /version:\s*"2026\.06\.18\.(?:205|206|207|208|209|210|211|212|213|214|215|216|217)"/, 'build-info should publish v305');
...
assert.match(buildInfo, /expectedServiceWorkerCache:\s*"fuel-ledger-v(?:305|306|307|308|309|310|311|312|313|314|315|316|317)"/, 'build-info should expect v305 cache');
assert.match(serviceWorker, /CACHE_NAME\s*=\s*"fuel-ledger-v(?:305|306|307|308|309|310|311|312|313|314|315|316|317)"/, 'service worker cache should be v305');
