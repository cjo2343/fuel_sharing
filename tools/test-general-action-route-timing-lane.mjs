...
assert.match(buildInfo, /buildLabel:\s*"general-action-route-timing-lane"/, 'build label should describe the general action route timing lane');
assert.match(buildInfo, /expectedServiceWorkerCache:\s*"fuel-ledger-v409"/, 'service worker cache must be bumped for runtime changes');
