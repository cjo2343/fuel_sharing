...
assert.match(buildInfo, /buildLabel:\s*"render-api-client-extraction-lane|update-prompt-bridge-workspace-retention-lane|update-prompt-workspace-visibility-lane|general-action-route-timing-lane"/, 'build label should describe the general action route timing lane');
assert.match(buildInfo, /expectedServiceWorkerCache:\s*"fuel-ledger-v(?:409|410|411|412|413|414|415|416|417|418|419|420|421|422)"/, 'service worker cache must be bumped for runtime changes');
