...
assert.match(buildInfo, /expectedServiceWorkerCache:\s*"fuel-ledger-v(?:409|410|411|412|413|414|415|416|417)"/, 'service worker cache must be bumped for runtime changes');
