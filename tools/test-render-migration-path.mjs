...
assert.ok(app.includes('withNormalizedWriteContextTimeout(getNormalizedWriteContext({ syncDirectory: false, source: "booking-save" }), "booking-save")'), "booking saves must time-bound pre-backend normalized context setup");
