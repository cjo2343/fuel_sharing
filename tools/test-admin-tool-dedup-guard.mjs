...
assert.match(buildInfo, /version:\s*"2026\.06\.18\.(?:219|220|221|222|222|223|224|225|226|227|228|229|230)"/, "runtime version should be bumped for admin tool dedupe runtime changes.");
assert.match(buildInfo, /expectedServiceWorkerCache:\s*"fuel-ledger-v(?:319|320|321|322|323|324|325|326|327|328|329|330)"/, "build-info should expect the bumped service-worker cache.");
assert.match(serviceWorker, /CACHE_NAME\s*=\s*"fuel-ledger-v(?:319|320|321|322|323|324|325|326|327|328|329|330)"/, "service worker cache should be bumped with runtime changes.");
