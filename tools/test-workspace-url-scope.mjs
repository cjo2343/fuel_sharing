...
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v378"/, 'build-info should point to v375 cache.');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v378"/, 'service worker cache should be bumped to v365.');
