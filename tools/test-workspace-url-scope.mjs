...
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v377"/, 'build-info should point to v375 cache.');
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v377"/, 'service worker cache should be bumped to v365.');
