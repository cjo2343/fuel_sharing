...
assert.match(build, /fuel-ledger-v(?:395|396|397|398|399|400|401|402|403|404|405)/, 'build-info expected cache should be v395 or later');
assert.match(sw, /fuel-ledger-v(?:395|396|397|398|399|400|401|402|403|404|405)/, 'service worker cache should be v395 or later');
