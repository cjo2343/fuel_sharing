...
assert.match(build, /no-refresh-action-chain-lane|post-action-unblock-lane|multi-workspace-authority-lane|admin-panel-declutter-lane|workspace-switch-target-context-lane|startup-wake-gate-lane|render-workspace-tools-lane|render-owned-state-load-lane/, 'build label should describe the state scope lane');
assert.match(build, /fuel-ledger-v(?:395|396|397|398|399|400|401|402|403|404)/, 'build-info expected cache should be v395 or later');
assert.match(sw, /fuel-ledger-v(?:395|396|397|398|399|400|401|402|403|404)/, 'service worker cache should be v395 or later');
