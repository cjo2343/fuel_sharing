...
assert(app.includes('const appliedContext = appBackendContextStatus?.decision === "stale-backend-context-ignored" ? getBackendAppContext() : result.context;'), 'getRenderAppContext must return the retained context after ignoring a stale response');
