...
assert.match(appSource, /activityLimit: 20/, "Global diagnostics auto-refresh should request a bounded activity window.");
assert.match(appSource, /workspaceLimit: 80/, "Global diagnostics auto-refresh should keep workspace queries bounded.");
assert.match(appSource, /memberLimit: 300/, "Global diagnostics auto-refresh should keep member queries bounded.");
