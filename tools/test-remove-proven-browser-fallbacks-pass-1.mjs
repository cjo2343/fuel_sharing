...
assert.match(buildInfo, /buildLabel:\s*"(?:app-session-hydrate-lane|remove-proven-browser-fallbacks-pass-1|render-admin-report-save-route)"/, 'build-info should use v306 label');
...
assert.match(serviceWorker, /BUILD_LABEL\s*=\s*"(?:app-session-hydrate-lane|remove-proven-browser-fallbacks-pass-1|render-admin-report-save-route)"/, 'service worker label should match v306');
