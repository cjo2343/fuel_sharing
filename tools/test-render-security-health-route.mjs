...
assert.match(buildInfo, /version: "2026\.06\.18\.211"/, "build-info version must be bumped");
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v311"/, "build-info cache must be bumped");
...
assert.match(serviceWorker, /fuel-ledger-v311/, "service worker cache must be bumped");
