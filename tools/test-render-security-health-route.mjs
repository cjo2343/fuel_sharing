...
assert.match(buildInfo, /version: "2026\.06\.18\.(?:213|214|215|216|217|218|219|220|221)"/, "build-info version must be bumped");
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v(?:31[456789]|320|321|321)"/, "build-info cache must be bumped");
...
assert.match(serviceWorker, /fuel-ledger-v(?:31[456789]|320|321|321)/, "service worker cache must be bumped");
