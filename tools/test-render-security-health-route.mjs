...
assert.match(buildInfo, /version: "2026\.06\.18\.(?:213|214|215)"/, "build-info version must be bumped");
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v31[45]"/, "build-info cache must be bumped");
...
assert.match(serviceWorker, /fuel-ledger-v31[45]/, "service worker cache must be bumped");
