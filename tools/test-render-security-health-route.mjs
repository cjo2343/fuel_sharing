...
assert.match(buildInfo, /version: "2026\.06\.18\.(?:213|214|215|216|217)"/, "build-info version must be bumped");
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v31[4567]"/, "build-info cache must be bumped");
...
assert.match(serviceWorker, /fuel-ledger-v31[4567]/, "service worker cache must be bumped");
