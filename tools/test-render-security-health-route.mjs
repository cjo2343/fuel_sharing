...
assert.match(buildInfo, /version: "2026\.06\.18\.(?:213|214|215|216|217|218|219|220|221|222|222|222|222|222|222|222|222|223|224|225|226|227|228|229|230|231|232|233|234)"/, "build-info version must be bumped");
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v(?:31[456789]|320|321|322|323|324|325|326|327|328|329|330|331|332|333|334)"/, "build-info cache must be bumped");
...
assert.match(serviceWorker, /fuel-ledger-v(?:31[456789]|320|321|322|323|324|325|326|327|328|329|330|331|332|333|334)/, "service worker cache must be bumped");
