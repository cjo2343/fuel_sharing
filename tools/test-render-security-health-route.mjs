...
assert.match(buildInfo, /version: "2026\.06\.18\.(?:213|214)"/, "build-info version must be bumped");
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v314"/, "build-info cache must be bumped");
...
assert.match(serviceWorker, /fuel-ledger-v314/, "service worker cache must be bumped");
