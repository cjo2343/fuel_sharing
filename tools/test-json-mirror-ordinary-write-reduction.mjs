...
assert.match(buildInfo, /version: "2026\.06\.18\.(?:215|216|217|218|219|220|221|222|222|222|222|222|222|223|224|225|226|227|228|229|230|231)"/, 'Runtime version should be bumped for app.js changes.');
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v(?:315|316|317|318|319|320|321|322|323|324|325|326|327|328|329|330|331)"/, 'Expected service worker cache should be bumped.');
assert.match(serviceWorker, /fuel-ledger-v(?:315|316|317|318|319|320|321|322|323|324|325|326|327|328|329|330|331)/, 'Service worker cache should be bumped with build-info.');
