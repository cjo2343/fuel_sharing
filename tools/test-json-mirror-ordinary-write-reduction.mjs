...
assert.match(buildInfo, /version: "2026\.06\.18\.(?:215|216|217|218|219|220|221|222|222|222|222|222|222|223|224|225|226|227|228|229|230|231|232|233|234|235|236|237|238|239|240|241|242|243|244|245|246)"/, 'Runtime version should be bumped for app.js changes.');
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v(?:315|316|317|318|319|320|321|322|323|324|325|326|327|328|329|330|331|332|333|334|335|336|337|338|339|340|341|342|343|344|345|346)"/, 'Expected service worker cache should be bumped.');
assert.match(serviceWorker, /fuel-ledger-v(?:315|316|317|318|319|320|321|322|323|324|325|326|327|328|329|330|331|332|333|334|335|336|337|338|339|340|341|342|343|344|345|346)/, 'Service worker cache should be bumped with build-info.');
