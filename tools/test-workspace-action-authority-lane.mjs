...
assert.match(buildInfo, /version: "2026\.06\.18\.277"/);
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v418"/);
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v418"/);
