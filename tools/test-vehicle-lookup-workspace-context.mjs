...
assert(app.includes('readActiveWorkspaceIdFromCurrentUrl() || getActiveLedgerId()'), 'vehicle lookup should prefer the URL/requested workspace when checking context');
