...
assert((/fuel-ledger-v(?:394|395|396|397|398|399|400|401|402|403|404)/.test(build) && /fuel-ledger-v(?:394|395|396|397|398|399|400|401|402|403|404)/.test(sw)), "runtime cache bumped to v389");
