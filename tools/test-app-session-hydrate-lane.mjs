...
assert.match(build, /fuel-ledger-v(?:394|395|396|397|398|399|400|401|402)/, 'build-info expected cache should be v394');
assert.match(sw, /fuel-ledger-v(?:394|395|396|397|398|399|400|401|402)/, 'service worker cache should be v394');
