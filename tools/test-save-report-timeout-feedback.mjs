...
assert.match(buildInfo, /buildLabel:\s*"(?:app-session-hydrate-lane|save-report-timeout-feedback|backend-path-simplification-audit|remove-proven-browser-fallbacks-pass-1|render-admin-report-save-route)"/, 'build-info should use v304 or later label');
...
assert.match(serviceWorker, /BUILD_LABEL\s*=\s*"(?:app-session-hydrate-lane|save-report-timeout-feedback|backend-path-simplification-audit|remove-proven-browser-fallbacks-pass-1|render-admin-report-save-route)"/, 'service worker label should match v304 or later');
