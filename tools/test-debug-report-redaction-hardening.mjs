...
assert.match(buildInfo, /version:\s*"2026\.06\.18\.(?:218|219|220|221|222|222|222|223|224|225|226|227|228|229|230|231|232|233|234|235|236|237|238|239|240|241)"/, "runtime version should be bumped for redaction hardening");
assert.match(buildInfo, /expectedServiceWorkerCache:\s*"fuel-ledger-v(?:31[89]|320|321|322|323|324|325|326|327|328|329|330|331|332|333|334|335|336|337|338|339|340|341)"/, "build-info should point at v318 cache");
assert.match(serviceWorker, /CACHE_NAME\s*=\s*"fuel-ledger-v(?:31[89]|320|321|322|323|324|325|326|327|328|329|330|331|332|333|334|335|336|337|338|339|340|341)"/, "service worker should use v318 cache");
