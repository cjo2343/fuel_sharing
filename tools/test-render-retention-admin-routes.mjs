...
assert.match(buildInfo, /version: "2026\.06\.18\.(?:200|201|202|203|204|205|206|207|208|209|210|211|212)"/);
...
assert.match(buildInfo, /expectedServiceWorkerCache: "fuel-ledger-v(?:300|301|302|303|304|305|306|307|308|309|310|311|312)"/);
assert.match(serviceWorker, /CACHE_NAME = "fuel-ledger-v(?:300|301|302|303|304|305|306|307|308|309|310|311|312)"/);
