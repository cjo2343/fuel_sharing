...
assert(server.includes("linkedWorkspaces") && server.includes("activeWorkspace") && server.includes("permissions"), "context includes active workspace, linked workspaces, and permissions");
...
assert(build.includes("fuel-ledger-v388") && sw.includes("fuel-ledger-v388"), "runtime cache bumped to v388");
