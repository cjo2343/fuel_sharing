...
assert.match(buildInfo, /version:\s*"2026\.06\.18\.(?:214|215|216|217|218|219|220|221|222|222|222|222|222|222|222|223|224|225|226|227|228|229|230|231|232|233|234|235|236)"/, 'runtime version must be bumped for app.js changes.');
assert.match(buildInfo, /expectedServiceWorkerCache:\s*"fuel-ledger-v(?:31[456789]|320|321|322|323|324|325|326|327|328|329|330|331|332|333|334|335|336)"/, 'build-info must expect the bumped service-worker cache.');
assert.match(serviceWorker, /CACHE_NAME\s*=\s*"fuel-ledger-v(?:31[456789]|320|321|322|323|324|325|326|327|328|329|330|331|332|333|334|335|336)"/, 'service-worker cache must be bumped with runtime changes.');
