...
assert(app.includes('hydrateAppSessionContext({ reason: "state-load", preferredWorkspaceId: ledgerId, source: "state-load" })'), "state load sends active workspace through the app session hydrate lane");
...
assert(build.includes("fuel-ledger-v393") && sw.includes("fuel-ledger-v393"), "runtime cache bumped to v393");
