...
assert.match(buildInfo, /buildLabel:\s*"(?:workspace-switch-target-context-lane|startup-wake-gate-lane|render-workspace-tools-lane|render-owned-state-load-lane|workspace-state-scope-lane|app-session-hydrate-lane|render-admin-report-save-route)"/, 'build-info should use v307 label');
...
assert.match(serviceWorker, /BUILD_LABEL\s*=\s*"(?:workspace-switch-target-context-lane|startup-wake-gate-lane|render-workspace-tools-lane|render-owned-state-load-lane|workspace-state-scope-lane|app-session-hydrate-lane|render-admin-report-save-route)"/, 'service worker label should match v307');
