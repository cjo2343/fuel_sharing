...
assert.match(buildInfo, /version:\s*"2026\.06\.18\.(?:201|202|203|204|205|206|207|208|209)"/, "build-info.js must be bumped to v301.");
...
assert.match(buildInfo, /expectedServiceWorkerCache:\s*"fuel-ledger-v30[1-9]"/, "build-info.js must expect the v301 cache.");
assert.match(serviceWorker, /CACHE_NAME\s*=\s*"fuel-ledger-v30[1-9]"/, "service-worker.js must use the v301 cache.");
