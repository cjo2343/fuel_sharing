...
assert.match(build, /fuel-ledger-v(?:394|395|396|397|398)/, 'build-info expected cache should be v392');
assert.match(sw, /fuel-ledger-v(?:394|395|396|397|398)/, 'service worker cache should be v392');
