...
assert.match(build, /fuel-ledger-v(?:394|395|396|397|398|399|400)/, 'build-info expected cache should be v392');
assert.match(sw, /fuel-ledger-v(?:394|395|396|397|398|399|400)/, 'service worker cache should be v392');
