...
--     null). Bookings get made in one person's name and driven by another all the
--     time; when a trip has actually been logged, its driver is the one who parked
--     the car and is often the only person who can answer any of these questions;
