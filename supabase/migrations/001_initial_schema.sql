-- Migration 001: initial tables, indexes, seed ledger/member records, push subscriptions, and ledger_events.
-- Safe to rerun: uses create/insert if not exists and on conflict guards.
