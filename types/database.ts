...
// Source: supabase-schema.sql @ migration 205 · supabase CLI v2.109.1 (exact-pinned)
...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      get_active_newsletter_send_job: {
        Args: never
        Returns: {
          campaign_id: string
          created_at: string
